...
<head>
    ...
    <link href="/third-party/metisMenu/metisMenu.min.css" rel="stylesheet">
     ...
     <!-- DataTables CSS -->
    <link href="/third-party/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="/third-party/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
...
<body>
    ...
    <script src="/third-party/datatables/js/jquery.dataTables.min.js"></script>
    <script src="/third-party/datatables-plugins/dataTables.bootstrap.min.js"></script>
    <script src="/third-party/datatables-responsive/dataTables.responsive.js"></script>
    ...
    $(document).ready(function() {
        $('#dataTables-example').DataTable({
            responsive: true,
            language: {
                url: '/third-party/datatables/i18n/chinese.json'
            }
        });
    });
    </script>
