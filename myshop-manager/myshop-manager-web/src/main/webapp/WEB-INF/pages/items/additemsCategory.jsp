...
<div class="row">
	<div class="col-lg-12">
		<form class="form-horizontal valid-form" id="itemCategoryAddForm" action="javascript:void(0)" method="post">
			<div class="row">
				<div class="col-lg-7">
					<div class="form-group">
						<label for="itemCategoryName" class="col-lg-5 control-label">新增类别名称:</label>
						<div class="col-lg-7">
